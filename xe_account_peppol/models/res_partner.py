...
class Partner(models.Model):
    ...
    creditor_number = fields.Char(string="Creditor No.", store=True, readonly=True, tracking=True)
    ...
    def action_fetch_peppol_endpoint(self):
        ...
        payload = {
            "platform_id": 15,
            "client_number": int(company_id.client_number),
            "name": self.name,
        ...
        try:
            client_number = company_id.client_number
